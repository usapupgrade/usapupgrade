          ...
          <div className="flex items-center justify-center">
            ...
            >
              ...
              <div className="text-center mb-10">
                <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white px-5 py-3 rounded-full text-sm font-semibold mb-6">
          ...
          <div className="flex items-center justify-center">
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 place-items-center sm:place-items-stretch">
                <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100 w-full max-w-sm sm:max-w-none text-center sm:text-left">
                  <div className="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center mb-4 mx-auto sm:mx-0">
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100 w-full max-w-sm sm:max-w-none text-center sm:text-left">
                  <div className="w-10 h-10 bg-purple-100 rounded-lg flex items-center justify-center mb-4 mx-auto sm:mx-0">
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100 w-full max-w-sm sm:max-w-none text-center sm:text-left">
                  <div className="w-10 h-10 bg-green-100 rounded-lg flex items-center justify-center mb-4 mx-auto sm:mx-0">
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100 w-full max-w-sm sm:max-w-none text-center sm:text-left">
                  <div className="w-10 h-10 bg-orange-100 rounded-lg flex items-center justify-center mb-4 mx-auto sm:mx-0">
              ...
              <div className="bg-gradient-to-r from-orange-50 to-red-50 border border-orange-200 rounded-2xl p-6 text-center sm:text-left">
